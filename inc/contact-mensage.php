<section id="information">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h1>Quer saber mais sobre como o <br>IEG pode ajudar a sua empresa?</h1>
        <h3>Deixe uma mensagem que <br>entraremos em contato com você</h3>
      </div>
      ...
      <div class="col-md-12 btn-send">
        <button type="button" class="btn btn-light btn-information">Enviar</button>
      </div>
